...
import type { AutopusConfig } from "./config-utils.js";
...
const rootMemoryConfig = (workspaceDir: string): AutopusConfig =>
  ({
    agents: {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as AutopusConfig;
