...
# Output:
# - dist/Autopus.app
# - dist/Autopus-<version>.zip
# - dist/Autopus-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.autopus.mac}"
...
ZIP="$ROOT_DIR/dist/Autopus-$VERSION.zip"
DMG="$ROOT_DIR/dist/Autopus-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Autopus-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Autopus-$VERSION.dSYM.zip"
