...
- AUTOPUS_IOS_VERSION = exact canonical iOS version
- AUTOPUS_MARKETING_VERSION = short iOS/App Store version
- AUTOPUS_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
AUTOPUS_IOS_VERSION = ${IOS_VERSION}
AUTOPUS_MARKETING_VERSION = ${MARKETING_VERSION}
AUTOPUS_BUILD_VERSION = ${BUILD_NUMBER}
EOF
