...
show_usage() {
    cat << EOF
clawlog - Autopus Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Autopus logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Autopus logs flow through the macOS unified log (subsystem: ai.autopus).
