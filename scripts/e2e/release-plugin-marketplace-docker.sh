...
IMAGE_NAME="$(docker_e2e_resolve_image "autopus-release-plugin-marketplace-e2e" AUTOPUS_RELEASE_PLUGIN_MARKETPLACE_E2E_IMAGE)"
SKIP_BUILD="${AUTOPUS_RELEASE_PLUGIN_MARKETPLACE_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-plugin-marketplace "${AUTOPUS_CURRENT_PACKAGE_TGZ:-}")"
...
AUTOPUS_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-plugin-marketplace empty)"
