...
IMAGE_NAME="$(docker_e2e_resolve_image "autopus-release-user-journey-e2e" AUTOPUS_RELEASE_USER_JOURNEY_E2E_IMAGE)"
SKIP_BUILD="${AUTOPUS_RELEASE_USER_JOURNEY_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-user-journey "${AUTOPUS_CURRENT_PACKAGE_TGZ:-}")"
...
AUTOPUS_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-user-journey empty)"
