...
IMAGE_NAME="$(docker_e2e_resolve_image "autopus-crestodian-planner-e2e" AUTOPUS_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="autopus-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t autopus-crestodian-planner-log.XXXXXX)"
...
AUTOPUS_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
