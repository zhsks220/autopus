...
IMAGE_NAME="$(docker_e2e_resolve_image "autopus-crestodian-rescue-e2e" AUTOPUS_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="autopus-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t autopus-crestodian-rescue-log.XXXXXX)"
...
AUTOPUS_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"
