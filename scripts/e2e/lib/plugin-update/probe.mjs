...
const pluginRecordSnapshot = () => {
  const config = readJson(autopusPath("autopus.json"));
...
function seedInstallState() {
  writeJson(autopusPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.AUTOPUS_CONFIG_PATH, { plugins: {} });
  writeJson(autopusPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Autopus plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Autopus will continue without it")
  );
}
