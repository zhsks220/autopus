...
export function resolveTavilySearchConfig(cfg?: AutopusConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: AutopusConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: AutopusConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
