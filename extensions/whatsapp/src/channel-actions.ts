...
function areWhatsAppAgentReactionsEnabled(params: { cfg: AutopusConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: AutopusConfig) {
