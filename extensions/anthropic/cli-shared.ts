...
// steer Autopus-managed Claude CLI runs toward a different provider,
...
function isAutopusRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isAutopusRequestedYolo(context)
