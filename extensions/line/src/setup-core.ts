import type { ChannelSetupAdapter, AutopusConfig } from "autopus/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "autopus/plugin-sdk/setup";
...
export function isLineConfigured(cfg: AutopusConfig, accountId: string): boolean {
