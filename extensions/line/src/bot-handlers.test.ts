...
vi.mock("autopus/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("autopus/plugin-sdk/command-auth", () => ({
...
vi.mock("autopus/plugin-sdk/runtime-group-policy", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("autopus/plugin-sdk/channel-inbound");
    vi.doUnmock("autopus/plugin-sdk/channel-pairing");
    vi.doUnmock("autopus/plugin-sdk/command-auth");
    vi.doUnmock("autopus/plugin-sdk/runtime-group-policy");
    vi.doUnmock("autopus/plugin-sdk/runtime-env");
    vi.doUnmock("autopus/plugin-sdk/reply-history");
    vi.doUnmock("autopus/plugin-sdk/routing");
