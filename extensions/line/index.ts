...
type RegisteredLineCardCommand = Parameters<AutopusPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: AutopusPluginApi): Promise<RegisteredLineCardCommand> {
