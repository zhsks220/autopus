...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<AutopusConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<AutopusConfig["channels"]>["slack"]>>,
): AutopusConfig {
  return {
    channels: {
      slack: {
