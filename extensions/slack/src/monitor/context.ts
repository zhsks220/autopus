...
import { resolveDefaultAgentId } from "autopus/plugin-sdk/agent-runtime";
...
import type { DmPolicy, GroupPolicy } from "autopus/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "autopus/plugin-sdk/conversation-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("autopus/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
