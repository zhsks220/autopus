...
export function resolveSearxngCategories(config?: AutopusConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: AutopusConfig): string | undefined {
