...
import { normalizeSecretInputString, type SecretInput } from "autopus/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: AutopusConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: AutopusConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: AutopusConfig): string {
