...
function mergeZalouserAccountConfig(cfg: AutopusConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AutopusConfig; accountId?: string | null }) {
