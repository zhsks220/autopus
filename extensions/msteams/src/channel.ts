...
import { normalizeMessagePresentation } from "autopus/plugin-sdk/interactive-runtime";
...
import { createComputedAccountStatusAdapter } from "autopus/plugin-sdk/status-helpers";
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: AutopusConfig }>(
