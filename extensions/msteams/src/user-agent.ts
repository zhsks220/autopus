...
function resolveAutopusVersion(): string {
  try {
 ...
 * and appends the Autopus version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Autopus/<autopus-version>"
 * Example: "teams.ts[apps]/2.0.5 Autopus/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Autopus/${resolveAutopusVersion()}`;
  return cachedUserAgent;
}
