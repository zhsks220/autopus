...
type LitellmProviderConfig = NonNullable<NonNullable<AutopusConfig["models"]>["providers"]>[string];
...
function resolveConfiguredLitellmBaseUrl(cfg: AutopusConfig | undefined): string {
