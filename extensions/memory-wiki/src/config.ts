...
import { mapPluginConfigIssues } from "autopus/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type AutopusPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: AutopusPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".autopus", "wiki", "main");
}
