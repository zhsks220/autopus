...
const GENERATED_START = "<!-- autopus:wiki:generated:start -->";
const GENERATED_END = "<!-- autopus:wiki:generated:end -->";
const HUMAN_START = "<!-- autopus:human:start -->";
const HUMAN_END = "<!-- autopus:human:end -->";
