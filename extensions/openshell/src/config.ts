...
import { buildPluginConfigSchema, type AutopusPluginConfigSchema } from "autopus/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): AutopusPluginConfigSchema {
