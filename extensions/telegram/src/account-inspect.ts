import { resolveAccountWithDefaultFallback } from "autopus/plugin-sdk/account-core";
...
import { coerceSecretRef } from "autopus/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: AutopusConfig; value: unknown }): {
  token: string;
