...
import { createChannelPluginBase, type ChannelPlugin } from "autopus/plugin-sdk/channel-core";
 ...
 */
function isBlockedByMultiBotGuard(cfg: AutopusConfig, accountId: string): boolean {
