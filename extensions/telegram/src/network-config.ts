...
import { isTruthyEnvValue, isWSL2Sync } from "autopus/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "autopus/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "AUTOPUS_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "AUTOPUS_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "AUTOPUS_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable AUTOPUS_TELEGRAM_DNS_RESULT_ORDER
