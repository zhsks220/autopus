...
export function shouldShowTelegramDmAccessWarning(cfg: AutopusConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`autopus config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`autopus config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
