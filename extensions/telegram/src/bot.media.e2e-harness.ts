...
import { resetInboundDedupe } from "autopus/plugin-sdk/reply-runtime";
...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("autopus/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyHarnessParams = Parameters<DispatchReplyWithBufferedBlockDispatcherFn>[0];
type ReadRemoteMediaBufferFn =
  typeof import("autopus/plugin-sdk/media-runtime").readRemoteMediaBuffer;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  getRuntimeConfig: (() =>
    ...
    }) as AutopusConfig) as TelegramBotDeps["getRuntimeConfig"],
