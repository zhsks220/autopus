...
function mergeSignalAccountConfig(cfg: AutopusConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AutopusConfig): ResolvedSignalAccount[] {
