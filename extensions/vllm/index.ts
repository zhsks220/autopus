...
async function loadProviderSetup() {
  return await import("autopus/plugin-sdk/provider-setup");
}
  ...
  register(api: AutopusPluginApi) {
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set VLLM_API_KEY (any value works) or run "autopus configure". ' +
        "See: https://docs.autopus.ai/providers/vllm",
