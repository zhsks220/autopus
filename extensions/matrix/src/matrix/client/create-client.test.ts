...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/autopus-matrix-create-client-test",
    storagePath: "/tmp/autopus-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/autopus-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/autopus-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/autopus-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "autopus-matrix-default-token-hash",
