import { resolveConfiguredAcpBindingRecord } from "autopus/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "autopus/plugin-sdk/session-binding-runtime";
