...
export type MatrixStreamingConfig = {
  ...
  progress?: import("autopus/plugin-sdk/channel-streaming").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<AutopusConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: AutopusConfig["secrets"];
  [key: string]: unknown;
};
