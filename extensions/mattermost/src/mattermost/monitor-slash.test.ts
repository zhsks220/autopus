...
describe("mattermost monitor slash", () => {
  ...
  it("registers deduped default and native skill commands across teams", async () => {
    vi.stubEnv("AUTOPUS_GATEWAY_PORT", "18888");
    ...
    resolveCallbackUrl.mockReturnValue("https://autopus.test/slash");
    ...
    expect(firstRegistration).toEqual({
      ...
      callbackUrl: "https://autopus.test/slash",
      commands: [
        { trigger: "ping", description: "ping" },
        {
          trigger: "oc_skill",
    ...
    expect(runtime.log).toHaveBeenCalledWith(
      "mattermost: slash commands registered (2 commands across 2 teams, callback=https://autopus.test/slash)",
    );
  });
