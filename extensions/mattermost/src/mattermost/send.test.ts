import { expectProvidedCfgSkipsRuntimeLoad } from "autopus/plugin-sdk/channel-test-helpers";
...
vi.mock("autopus/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("autopus/plugin-sdk/text-chunking", () => ({
