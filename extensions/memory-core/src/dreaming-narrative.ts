...
import { createAsyncLock } from "autopus/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "autopus/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "autopus/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "autopus/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- autopus:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- autopus:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "autopus:dreaming:backfill-entry";
