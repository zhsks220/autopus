...
import {
  ...
  sessionPathForFile,
} from "autopus/plugin-sdk/memory-core-host-engine-qmd";
...
import { appendRegularFile, privateFileStore } from "autopus/plugin-sdk/security-runtime";
...
const LIGHT_SLEEP_EVENT_TEXT = "__autopus_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__autopus_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- autopus:dreaming:light:start -->",
    endMarker: "<!-- autopus:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- autopus:dreaming:rem:start -->",
    endMarker: "<!-- autopus:dreaming:rem:end -->",
  },
] as const;
