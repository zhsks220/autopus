...
const MCPORTER_STATE_KEY = Symbol.for("autopus.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("autopus.qmdEmbedQueueTail");
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status" | "cli"; cfg?: AutopusConfig }) {
