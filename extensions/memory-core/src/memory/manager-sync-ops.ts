...
import { classifyMemoryMultimodalPath } from "autopus/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("autopus.test.memoryWatchFactory");
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: AutopusConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.AUTOPUS_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
