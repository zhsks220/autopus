...
import { collectProviderDangerousNameMatchingScopes } from "autopus/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: AutopusConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: AutopusConfig,
  doctorFixCommand: string,
): { config: AutopusConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: AutopusConfig): string[] {
