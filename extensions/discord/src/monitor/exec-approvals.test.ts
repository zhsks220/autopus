...
vi.mock("autopus/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("autopus/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
