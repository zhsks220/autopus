...
import { loadJsonFile, saveJsonFile } from "autopus/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "autopus/plugin-sdk/routing";
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("autopus.discordThreadBindingsState");
