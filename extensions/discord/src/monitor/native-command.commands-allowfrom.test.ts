...
import * as pluginCommandsModule from "autopus/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "autopus/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: AutopusConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: AutopusConfig) => void;
