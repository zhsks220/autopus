import { DEFAULT_ACCOUNT_ID, type AutopusConfig } from "autopus/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "autopus/plugin-sdk/webhook-ingress";
