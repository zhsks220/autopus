...
import { resolveDangerousNameMatchingEnabled } from "autopus/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Autopus config object. */
function getChannelConfig(cfg: AutopusConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: AutopusConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.AUTOPUS_BOT_NAME ?? "Autopus";
