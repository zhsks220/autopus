...
import type { AutopusPluginService } from "autopus/plugin-sdk/core";
import { listDevicePairing } from "autopus/plugin-sdk/device-bootstrap";
...
export function createPairingNotifierService(api: AutopusPluginApi): AutopusPluginService {
...
export function registerPairingNotifierService(api: AutopusPluginApi): void {
