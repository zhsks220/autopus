...
import { buildOauthProviderAuthResult } from "autopus/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "autopus/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "autopus/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: AutopusPluginApi) {
