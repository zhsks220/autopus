...
import type { ModelDefinitionConfig } from "autopus/plugin-sdk/provider-onboard";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "autopus-test-"));
  ...
  async function runOllamaCatalog(params: { config?: AutopusConfig; env?: NodeJS.ProcessEnv }) {
