...
export function registerNodesCameraCommands(nodes: Command) {
  const camera = nodes
    .command("camera")
    .description(t("desc.capture_camera_media_from_a_paired_node"));

  nodesCallOpts(
    camera
      .command("list")
      .description(t("desc.list_available_cameras_on_a_node"))
  ...
  nodesCallOpts(
    camera
      .command("snap")
      .description(t("desc.capture_a_photo_from_a_node_camera_prints_media_path"))
      .requiredOption("--node <idOrNameOrIp>", "Node id, name, or IP")
      .option("--facing <front|back|both>", t("opt.camera_facing"), "both")
      .option("--device-id <id>", t("opt.camera_device_id_from_nodes_camera_list"))
      .option("--max-width <px>", t("opt.max_width_in_px_optional"))
      .option("--quality <0-1>", t("opt.jpeg_quality_default_0_9"))
      .option("--delay-ms <ms>", t("opt.delay_before_capture_in_ms_macos_default_2000"))
  ...
  nodesCallOpts(
    camera
      .command("clip")
      .description(t("desc.capture_a_short_video_clip_from_a_node_camera_prints_media_path"))
      .requiredOption("--node <idOrNameOrIp>", "Node id, name, or IP")
      .option("--facing <front|back>", t("opt.camera_facing"), "front")
      .option("--device-id <id>", t("opt.camera_device_id_from_nodes_camera_list"))
      .option(
        "--duration <ms|10s|1m>",
      ...
      .option("--no-audio", t("opt.disable_audio_capture"))
      .option("--invoke-timeout <ms>", t("opt.node_invoke_timeout_in_ms_default_90000"), "90000")
