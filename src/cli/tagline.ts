const DEFAULT_TAGLINE = "모든 대화를, 하나의 Autopus 에서.";
...
const TAGLINES: string[] = [
  ...
  "The only octopus in your contacts you actually want to hear from. 🐙",
  ...
  "Built by octopuses, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'autopus gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.AUTOPUS_TAGLINE_INDEX;
