...
function resolveAcpStreamCoalesceIdleMs(cfg: AutopusConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: AutopusConfig): number {
...
export function resolveAcpProjectionSettings(cfg: AutopusConfig): AcpProjectionSettings {
