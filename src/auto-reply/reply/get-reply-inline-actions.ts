...
type AutopusToolsRuntime = typeof import("../../agents/autopus-tools.runtime.js");
...
const autopusToolsRuntimeLoader = createLazyImportLoader<AutopusToolsRuntime>(
  () => import("../../agents/autopus-tools.runtime.js"),
);
...
function loadAutopusToolsRuntime(): Promise<AutopusToolsRuntime> {
  return autopusToolsRuntimeLoader.load();
}
...
export async function handleInlineActions(params: {
  ...
  if (skillInvocation) {
    ...
    if (dispatch?.kind === "tool") {
      ...
      const { createAutopusTools } = await loadAutopusToolsRuntime();
