...
export function scanLegacyToolsBySenderKeys(cfg: AutopusConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AutopusConfig): {
