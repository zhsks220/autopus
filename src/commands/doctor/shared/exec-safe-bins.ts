...
function collectExecSafeBinScopes(cfg: AutopusConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: AutopusConfig): ExecSafeBinCoverageHit[] {
...
export function scanExecSafeBinTrustedDirHints(cfg: AutopusConfig): ExecSafeBinTrustedDirHintHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: AutopusConfig): {
