...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: AutopusConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: AutopusConfig, deps?: BrowserDoctorDeps) {
  try {
