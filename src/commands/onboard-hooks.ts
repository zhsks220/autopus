...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.autopus.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("autopus hooks list")}`,
      `  ${formatCliCommand("autopus hooks enable <name>")}`,
      `  ${formatCliCommand("autopus hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
