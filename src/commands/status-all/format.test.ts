...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://autopus.local")).toBe("https://autopus.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://autopus.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: autopus security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://autopus.local" },
      ...
      { Item: "Security", Value: "Run: autopus security audit --deep" },
