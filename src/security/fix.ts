...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AutopusConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AutopusConfig; env: NodeJS.ProcessEnv }): {
  cfg: AutopusConfig;
  changes: string[];
} {
