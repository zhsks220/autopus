...
let originalAutopusTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalAutopusTestConsole = process.env.AUTOPUS_TEST_CONSOLE;
  process.env.AUTOPUS_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalAutopusTestConsole === undefined) {
    delete process.env.AUTOPUS_TEST_CONSOLE;
  } else {
    process.env.AUTOPUS_TEST_CONSOLE = originalAutopusTestConsole;
  }
