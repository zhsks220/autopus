...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: AutopusConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: AutopusConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: AutopusConfig; accountId: string }) => boolean;
  inspect: (params: { cfg: AutopusConfig; accountId: string }) => ChannelSetupWizardCredentialState;
  shouldPrompt?: (params: {
    cfg: AutopusConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: AutopusConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: AutopusConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: AutopusConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: AutopusConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: AutopusConfig) => AutopusConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: AutopusConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: AutopusConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: AutopusConfig, policy: DmPolicy, accountId?: string) => AutopusConfig;
