...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: AutopusConfig): string | undefined {
  ...
  function listAccountIds(cfg: AutopusConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AutopusConfig): string {
