...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: AutopusConfig) => string[];
  resolveAccount: (cfg: AutopusConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: AutopusConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: AutopusConfig) => string;
  setAccountEnabled?: (params: {
    cfg: AutopusConfig;
    accountId: string;
    enabled: boolean;
  }) => AutopusConfig;
  deleteAccount?: (params: { cfg: AutopusConfig; accountId: string }) => AutopusConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: AutopusConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: AutopusConfig) => string>;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AutopusConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AutopusConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AutopusConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: AutopusConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: AutopusConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: AutopusConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.autopus.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: AutopusConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: AutopusConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: AutopusConfig;
    nextCfg: AutopusConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: AutopusConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: AutopusConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: AutopusConfig; accountId?: string | null }) =>
    | {
