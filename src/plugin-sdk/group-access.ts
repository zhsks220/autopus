...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `autopus/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `autopus/plugin-sdk/channel-ingress-runtime`. */
