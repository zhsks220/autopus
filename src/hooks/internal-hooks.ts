/**
 * Hook system for Autopus agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("autopus.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("autopus.internalHooksEnabled");
