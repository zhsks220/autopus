...
export function isAcpEnabledByPolicy(cfg: AutopusConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: AutopusConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: AutopusConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: AutopusConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: AutopusConfig): AcpRuntimeError | null {
...
export function resolveAcpExplicitTurnPolicyError(cfg: AutopusConfig): AcpRuntimeError | null {
  if (isAcpEnabledByPolicy(cfg)) {
    return null;
  }
...
export function isAcpAgentAllowedByPolicy(cfg: AutopusConfig, agentId: string): boolean {
