...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: AutopusConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: AutopusConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: AutopusConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: AutopusConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: AutopusConfig }): Promise<void> {
