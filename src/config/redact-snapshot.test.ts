...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/autopus.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/autopus/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/autopus/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/autopus/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/autopus/nickserv-password.txt");
