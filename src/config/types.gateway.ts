...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "autopus.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/autopus"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__autopus__/canvas or /__autopus__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
   ...
   * startup. Lets operators manage Funnel exposure outside Autopus without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/autopus/autopus/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var AUTOPUS_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
