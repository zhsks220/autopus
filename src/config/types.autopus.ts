...
export type AutopusConfig = {
  $schema?: string;
  meta?: {
    /** Last Autopus version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Autopus UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const autopusConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = AutopusConfig & {
  readonly [autopusConfigStateBrand]?: TState;
};
