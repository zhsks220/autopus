 ...
 *
 * @see https://github.com/autopus/autopus/issues/31884
 * @see https://github.com/autopus/autopus/issues/18558
 */
...
const INTERNAL_RUNTIME_DELIMITED_BLOCKS = [
  ["<<<BEGIN_AUTOPUS_INTERNAL_CONTEXT>>>", "<<<END_AUTOPUS_INTERNAL_CONTEXT>>>"],
] as const;
