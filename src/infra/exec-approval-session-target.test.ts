...
function resolveSlackPluginOriginTarget(params: { cfg: AutopusConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "autopus-exec-approval-session-target-" }, (tmpDir) => {
