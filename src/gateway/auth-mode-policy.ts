...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AutopusConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AutopusConfig): void {
