...
function resolveResolutionLimits(config: AutopusConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: AutopusConfig): SecretProviderConfig {
