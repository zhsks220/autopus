...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/autopus-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: AutopusConfig, agentId?: string): SandboxConfig {
