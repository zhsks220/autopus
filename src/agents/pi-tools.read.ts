...
function resolveAdaptiveReadMaxBytes(options?: AutopusReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAutopusReadTool(base, {
...
export function createAutopusReadTool(
  base: AnyAgentTool,
  options?: AutopusReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
