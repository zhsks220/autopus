...
import { planAutopusModelsJson } from "./models-config.plan.js";
...
function resolveModelsConfigInput(config?: AutopusConfig): {
  config: AutopusConfig;
  sourceConfigForSecrets: AutopusConfig;
} {
...
export async function ensureAutopusModelsJson(
  config?: AutopusConfig,
