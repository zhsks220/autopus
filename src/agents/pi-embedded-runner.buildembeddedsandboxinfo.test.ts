...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/autopus-sandbox",
    agentWorkspaceDir: "/tmp/autopus-workspace",
    workspaceAccess: "none",
    runtimeId: "autopus-sbx-test",
    runtimeLabel: "autopus-sbx-test",
    containerName: "autopus-sbx-test",
    ...
    browser: {
      ...
      containerName: "autopus-sbx-browser-test",
    },
