...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "autopus-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "autopus-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "autopus-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "autopus-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "autopus-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "autopus-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "autopus-legacy-state");
    const configDir = path.join("/tmp", "autopus-current-config");
