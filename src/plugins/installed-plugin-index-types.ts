...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Autopus from plugin manifests, install records, and config policy. Use `autopus plugins registry --refresh`, `autopus plugins install/update/uninstall`, or `autopus plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored autopus.install metadata. This describes catalog/package
