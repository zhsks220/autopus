...
const resolveAuthAgentDir = (agentDir?: string, config?: AutopusConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: AutopusConfig): SecretRef {
