...
function makeTempDir() {
  return makeTrackedTempDir("autopus-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat autopus.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "autopus.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
