---
name: autopus-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Autopus GitHub Secret Scanning alerts in issues or PRs.
---

# Autopus Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/autopus/autopus/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/autopus-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/autopus/autopus/issues/63101#issuecomment-xxx",
