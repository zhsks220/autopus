---
summary: "Adds Amazon Bedrock Mantle model provider support to Autopus."
read_when:
...
Adds Amazon Bedrock Mantle model provider support to Autopus.

## Distribution

- Package: `@autopus/amazon-bedrock-mantle-provider`
- Install route: npm
