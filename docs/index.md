---
summary: "Autopus is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Autopus to newcomers
title: "Autopus"
---
...
<p align="center">
    <img
        src="/assets/autopus-logo-text-dark.png"
        alt="Autopus"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/autopus-logo-text.png"
        alt="Autopus"
        width="500"
...
> _"EXFOLIATE! EXFOLIATE!"_ — A space octopus, probably
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Autopus and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `autopus onboard` and pairing flows.
  </Card>
...
Autopus is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents like Pi. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-autopus.jpg" alt="Autopus" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.autopus/autopus.json`.

- If you **do nothing**, Autopus uses the bundled Pi binary in RPC mode with per-sender sessions.
