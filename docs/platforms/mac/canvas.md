...
- `autopus-canvas://main/` → `<canvasRoot>/main/index.html`
- `autopus-canvas://main/assets/app.css` → `<canvasRoot>/main/assets/app.css`
- `autopus-canvas://main/widgets/todo/` → `<canvasRoot>/main/widgets/todo/index.html`
