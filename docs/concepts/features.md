---
summary: "Autopus capabilities across channels, routing, media, and UX."
read_when:
  - You want a full list of what Autopus supports
title: "Features"
---
...
- Skills, plugins, and workflow pipelines (Octopus)
...
<CardGroup cols={2}>
  ...
  <Card title="Plugins" href="/tools/plugin" icon="plug">
    Bundled and third-party plugins that extend Autopus.
  </Card>
</CardGroup>
