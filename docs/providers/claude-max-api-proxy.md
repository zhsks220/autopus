...
<Steps>
  ...
  <Step title="Configure Autopus">
    Point Autopus at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Autopus
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Autopus integration with Claude CLI or API keys.
  </Card>
