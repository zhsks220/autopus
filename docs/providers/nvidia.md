---
summary: "Use NVIDIA's OpenAI-compatible API in Autopus"
read_when:
  - You want to use open models in Autopus for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    autopus onboard --auth-choice nvidia-api-key
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    autopus models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
...
```bash
autopus onboard --auth-choice nvidia-api-key --nvidia-api-key "nvapi-..."
```
