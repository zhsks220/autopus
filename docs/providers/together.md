...
title: "Together AI"
read_when:
  - You want to use Together AI with Autopus
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    autopus onboard --auth-choice together-api-key
    ```
  </Step>
...
Autopus ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.autopus/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `autopus models list --provider together`
