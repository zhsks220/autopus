---
summary: "Overview of Autopus onboarding options and flows"
read_when:
...
Autopus has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `autopus onboard`                      | Launch the app            |
...
CLI command docs: [`autopus onboard`](/cli/onboard)

## macOS app onboarding

Open the Autopus app. The first-run wizard walks you through the same steps
