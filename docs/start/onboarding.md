---
summary: "First-run setup flow for Autopus (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Autopus">
...
<Step title="CLI">
  ...
  The app can install the global `autopus` CLI via npm, pnpm, or bun.
