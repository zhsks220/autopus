...
Zalo ships as a bundled plugin in current Autopus releases, so normal packaged
...
- Install via CLI: `autopus plugins install @autopus/zalo`
- Pinned version: `autopus plugins install @autopus/zalo@2026.5.2`
- Or from a source checkout: `autopus plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Autopus behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `autopus pairing list zalo`
  - `autopus pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Autopus.
...
- Example: `autopus message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `autopus channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `autopus logs --follow`
