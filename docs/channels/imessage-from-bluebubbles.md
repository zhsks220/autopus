...
| Threaded reply (`reply_to_guid`)                           | ✅                                  | ✅ (closes [#51892](https://github.com/autopus/autopus/issues/51892))                                                 |
| Tapback (`react`)                                          | ✅                                  | ✅                                                                                                                    |
| Edit / unsend (macOS 13+ recipients)                       | ✅                                  | ✅                                                                                                                    |
| Send with screen effect                                    | ✅                                  | ✅ (closes part of [#9394](https://github.com/autopus/autopus/issues/9394))                                           |
...
| Catchup of inbound messages received while gateway is down | ✅ (webhook replay + history fetch) | ✅ (opt-in via `channels.imessage.catchup.enabled`; closes [#78649](https://github.com/autopus/autopus/issues/78649)) |
