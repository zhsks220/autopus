...
Autopus = CLAW + TARDIS, because every space octopus needs a time and space machine.

## Credits

- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - Creator, octopus whisperer
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Pi creator, security pen tester
- **Clawd** - The space octopus who demanded a better name
...
MIT - Free as a octopus in the ocean.
