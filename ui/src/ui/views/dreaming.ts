...
const DIARY_START_RE = /<!--\s*autopus:dreaming:diary:start\s*-->/;
const DIARY_END_RE = /<!--\s*autopus:dreaming:diary:end\s*-->/;
...
function renderScene(props: DreamingProps, idle: boolean, dreamText: string) {
  return html`
    <section class="dreams ${idle ? "dreams--idle" : ""}">
      ...
      <div class="dreams__octopus">${sleepingOctopus}</div>
