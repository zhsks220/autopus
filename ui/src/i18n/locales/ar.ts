...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من autopus dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام autopus models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "الصق الرمز المميز من autopus dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل autopus doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل autopus dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل autopus devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: autopus devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "أعد فتح لوحة المعلومات المقدمة باستخدام autopus dashboard حتى يأتي UI وGateway من التثبيت نفسه.",
        stepDevUi:
          "إذا كنت تستخدم pnpm ui:dev، فأعد بناء أو تشغيل واجهة التطوير مقابل checkout الحالي.",
        stepRestart: "أعد تشغيل Gateway بعد تحديث Autopus حتى يقدم البروتوكول الحالي.",
      },
      network: {
        title: "تعذر الاتصال",
        summary:
          "لم يتمكن المتصفح من إكمال اتصال Gateway. تحقق من الهدف والنقل قبل إعادة تجربة بيانات الاعتماد.",
        stepGateway: "تأكد من أن Gateway يعمل باستخدام autopus status أو autopus gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام autopus dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  chat: {
