...
export const fa: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "روی موبایل هستید؟ URL کامل (شامل #token=...) را از autopus dashboard --no-open روی دسکتاپ خود کپی کنید.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — با autopus models auth دوباره احراز هویت کنید",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "توکن autopus dashboard --no-open را جای گذاری کنید یا گذرواژه پیکربندی شده را وارد کنید.",
        stepGenerate:
          "اگر توکنی پیکربندی نشده است، autopus doctor --generate-gateway-token را روی میزبان Gateway اجرا کنید.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "autopus dashboard --no-open را اجرا کنید و URL تازه را باز کنید یا توکن آن را جای گذاری کنید.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "autopus devices list را روی میزبان Gateway اجرا کنید.",
        stepApproveId: "این درخواست را تأیید کنید: autopus devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "داشبورد سرو شده را با autopus dashboard دوباره باز کنید تا UI و Gateway از همان نصب باشند.",
        stepDevUi:
          "اگر از pnpm ui:dev استفاده می کنید، UI توسعه را بر اساس checkout فعلی دوباره بسازید یا راه اندازی کنید.",
        stepRestart:
          "پس از به روزرسانی Autopus، Gateway را دوباره راه اندازی کنید تا پروتکل فعلی را سرو کند.",
      },
      network: {
        ...
        stepGateway:
          "با autopus status یا autopus gateway run تأیید کنید که Gateway در حال اجرا است.",
        stepUrl:
          "URL WebSocket را بررسی کنید و وقتی Gateway پشت HTTPS/Tailscale Serve است از wss:// استفاده کنید.",
        stepDashboard:
          "داشبورد را با autopus dashboard --no-open دوباره باز کنید تا URL و جزئیات احراز هویت فعلی را دوباره کپی کنید.",
      },
    },
  },
  chat: {
