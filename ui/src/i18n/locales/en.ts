...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from autopus dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with autopus models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authFailed: {
        ...
        stepDashboard: "Run autopus dashboard --no-open and open the fresh URL or paste its token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Run autopus devices list on the Gateway host.",
        stepApproveId: "Approve this request: autopus devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with autopus status or autopus gateway run.",
        stepUrl:
