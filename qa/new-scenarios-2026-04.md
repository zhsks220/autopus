...
- Code: `.agents/skills/autopus-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/autopus-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
