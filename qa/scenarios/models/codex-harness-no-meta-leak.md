...
execution:
  kind: flow
  summary: Run with `pnpm autopus qa suite --provider-mode live-frontier --model openai/gpt-5.5 --alt-model openai/gpt-5.5 --fast --thinking medium --scenario codex-harness-no-meta-leak`.
  config:
