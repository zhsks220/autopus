# 🐙 Autopus — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/autopus-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/autopus-logo-text.svg" alt="Autopus" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/autopus/autopus/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/autopus/autopus/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/autopus/autopus/releases"><img src="https://img.shields.io/github/v/release/autopus/autopus?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Autopus** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://autopus.ai) · [Docs](https://docs.autopus.ai) · [Vision](VISION.md) · [DeepWiki](https://deepwiki.com/autopus/autopus) · [Getting Started](https://docs.autopus.ai/start/getting-started) · [Updating](https://docs.autopus.ai/install/updating) · [Showcase](https://docs.autopus.ai/start/showcase) · [FAQ](https://docs.autopus.ai/help/faq) · [Onboarding](https://docs.autopus.ai/start/wizard) · [Nix](https://github.com/autopus/nix-autopus) · [Docker](https://docs.autopus.ai/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.autopus.ai/start/getting-started)

Preferred setup: run `autopus onboard` in your terminal.
Autopus Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/autopus/autopus/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.autopus.ai/start/onboarding).
...
# or: pnpm add -g autopus@latest

autopus onboard --install-daemon
```

Autopus Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.16+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.autopus.ai/start/getting-started)
...
# Send a message
autopus message send --target +1234567890 --message "Hello from Autopus"
...
autopus agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.autopus.ai/install/updating) (and run `autopus doctor`).

Models config + CLI: [Models](https://docs.autopus.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.autopus.ai/concepts/model-failover).

## Security defaults (DM access)

Autopus connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.autopus.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `autopus pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `autopus doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.autopus.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.autopus.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.autopus.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.autopus.ai/nodes/voicewake) + [Talk Mode](https://docs.autopus.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.autopus.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.autopus.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.autopus.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.autopus.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.autopus.ai/nodes).
- **[Onboarding](https://docs.autopus.ai/start/wizard) + [skills](https://docs.autopus.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.autopus.ai/gateway/security), [Sandboxing](https://docs.autopus.ai/gateway/sandboxing), and [Configuration](https://docs.autopus.ai/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.autopus.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.autopus.ai/start/getting-started), [Onboarding](https://docs.autopus.ai/start/wizard), [Updating](https://docs.autopus.ai/install/updating)
- Channel setup: [Channels index](https://docs.autopus.ai/channels), [WhatsApp](https://docs.autopus.ai/channels/whatsapp), [Telegram](https://docs.autopus.ai/channels/telegram), [Discord](https://docs.autopus.ai/channels/discord), [Slack](https://docs.autopus.ai/channels/slack)
- Apps + nodes: [macOS](https://docs.autopus.ai/platforms/macos), [iOS](https://docs.autopus.ai/platforms/ios), [Android](https://docs.autopus.ai/platforms/android), [Nodes](https://docs.autopus.ai/nodes)
- Config + security: [Configuration](https://docs.autopus.ai/gateway/configuration), [Security](https://docs.autopus.ai/gateway/security), [Sandboxing](https://docs.autopus.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.autopus.ai/gateway), [Remote access](https://docs.autopus.ai/gateway/remote), [Tailscale](https://docs.autopus.ai/gateway/tailscale), [Web surfaces](https://docs.autopus.ai/web)
- Tools + automation: [Tools](https://docs.autopus.ai/tools), [Skills](https://docs.autopus.ai/tools/skills), [Cron jobs](https://docs.autopus.ai/automation/cron-jobs), [Webhooks](https://docs.autopus.ai/automation/webhook), [Gmail Pub/Sub](https://docs.autopus.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.autopus.ai/concepts/architecture), [Agent](https://docs.autopus.ai/concepts/agent), [Session model](https://docs.autopus.ai/concepts/session), [Gateway protocol](https://docs.autopus.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.autopus.ai/channels/troubleshooting), [Logging](https://docs.autopus.ai/logging), [Docs home](https://docs.autopus.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.autopus.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `autopus nodes …`.

Runbook: [iOS connect](https://docs.autopus.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`autopus devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.autopus.ai/platforms/android).
...
`pnpm autopus setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm autopus onboard --install-daemon`.

Note: `pnpm autopus ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `autopus` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `autopus update --channel stable|beta|dev`.
Details: [Development channels](https://docs.autopus.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.autopus/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.autopus/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.autopus/autopus.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.autopus.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=autopus/autopus&type=date&legend=top-left)](https://www.star-history.com/#autopus/autopus&type=date&legend=top-left)

## Molty

Autopus was built for **Molty**, a space octopus AI assistant. 🐙
by Peter Steinberger and the community.

- [autopus.ai](https://autopus.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@autopus](https://x.com/autopus)
...
Special thanks to Adam Doppelt for the octopus.bot domain.
...
[![solstead](https://avatars.githubusercontent.com/u/168413654?v=4&s=48)](https://github.com/solstead) [![hengm3467](https://avatars.githubusercontent.com/u/100685635?v=4&s=48)](https://github.com/hengm3467) [![chziyue](https://avatars.githubusercontent.com/u/62380760?v=4&s=48)](https://github.com/chziyue) [![James L. Cowan Jr.](https://avatars.githubusercontent.com/u/112015792?v=4&s=48)](https://github.com/jameslcowan) [![scifantastic](https://avatars.githubusercontent.com/u/150712374?v=4&s=48)](https://github.com/scifantastic) [![ryan-octopusbe](https://avatars.githubusercontent.com/u/128659760?v=4&s=48)](https://github.com/ryan-octopusbe) [![alexfilatov](https://avatars.githubusercontent.com/u/138589?v=4&s=48)](https://github.com/alexfilatov) [![Luckymingxuan](https://avatars.githubusercontent.com/u/159552597?v=4&s=48)](https://github.com/Luckymingxuan) [![HollyChou](https://avatars.githubusercontent.com/u/128659251?v=4&s=48)](https://github.com/Hollychou924) [![badlogic](https://avatars.githubusercontent.com/u/514052?v=4&s=48)](https://github.com/badlogic)
