...
It does **not** own branching or business logic. Put that in Octopus, acpx, or the calling code.
...
- See `skills/taskflow/examples/inbox-triage.octopus`
- See `skills/taskflow/examples/pr-intake.octopus`
