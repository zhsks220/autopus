...
`precise.yml` is Autopus's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Autopus paths are excluded by `.gitignore` for build reasons even though
