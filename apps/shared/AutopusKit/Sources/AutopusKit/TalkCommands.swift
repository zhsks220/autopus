...
public enum AutopusTalkCommand: String, Codable, Sendable {
...
public struct AutopusTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct AutopusTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
