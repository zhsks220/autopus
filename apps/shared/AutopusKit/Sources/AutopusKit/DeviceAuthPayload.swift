...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: AutopusProtocol.AnyCodable]?
    {
        ...
        return [
            "id": AutopusProtocol.AnyCodable(identity.deviceId),
            "publicKey": AutopusProtocol.AnyCodable(publicKey),
            "signature": AutopusProtocol.AnyCodable(signature),
            "signedAt": AutopusProtocol.AnyCodable(signedAtMs),
            "nonce": AutopusProtocol.AnyCodable(nonce),
        ]
    }
}
