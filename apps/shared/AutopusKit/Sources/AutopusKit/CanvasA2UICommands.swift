...
public enum AutopusCanvasA2UICommand: String, Codable, Sendable {
...
public struct AutopusCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct AutopusCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
