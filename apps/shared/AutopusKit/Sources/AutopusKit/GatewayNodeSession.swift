...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.autopus", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.autopus", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: AutopusProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
