# Autopus iOS Changelog

## 2026.5.12 - 2026-05-12

Maintenance update for the current Autopus beta release.
...
Maintenance update for the current Autopus development release.
...
Maintenance update for the current Autopus release.
...
First App Store release of Autopus for iPhone. Pair with your Autopus Gateway to use chat, voice, sharing, and device actions from iOS.
