...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = AutopusLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = AutopusLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.autopus.ios", category: "GatewaySettings")
        ...
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Autopus agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Autopus agent.")
                        { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Autopus. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(AutopusLocationMode.off.rawValue)
                            Text("While Using").tag(AutopusLocationMode.whileUsing.rawValue)
                            Text("Always").tag(AutopusLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Autopus is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Autopus", value: DeviceInfoHelper.autopusVersionString())
                    }
                }
            }
            ...
            .onAppear {
                ...
                .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                    ...
                    guard let mode = AutopusLocationMode(rawValue: newValue) else { return }
                    Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Autopus chat and run /pair approve, then tap Connect again."
        }
