...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.autopus.gateway"
    private static let nodeService = "ai.autopus.node"
    private static let talkService = "ai.autopus.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.autopus.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.autopus.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("autopus-gateway.log")
    }
