...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: AutopusPhotosLatestParams) async throws -> AutopusPhotosLatestPayload {
        ...
        var results: [AutopusPhotoPayload] = []
        ...
        return AutopusPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> AutopusPhotoPayload
    {
