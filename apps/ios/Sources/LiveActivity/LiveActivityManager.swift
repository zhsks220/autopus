...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.autopus.ios", category: "LiveActivity")
    private var currentActivity: Activity<AutopusActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = AutopusActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<AutopusActivityAttributes>.activities
    ...
    private func updateCurrent(state: AutopusActivityAttributes.ContentState) {
    ...
    private func connectingState() -> AutopusActivityAttributes.ContentState {
        AutopusActivityAttributes.ContentState(
    ...
    private func idleState() -> AutopusActivityAttributes.ContentState {
        AutopusActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> AutopusActivityAttributes.ContentState {
        AutopusActivityAttributes.ContentState(
