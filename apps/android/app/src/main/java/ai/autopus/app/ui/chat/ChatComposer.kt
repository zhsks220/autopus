...
import ai.autopus.app.ui.mobileAccentBorderStrong
...
import ai.autopus.app.ui.mobileHeadline
import ai.autopus.app.ui.mobileSurface
import ai.autopus.app.ui.mobileText
import ai.autopus.app.ui.mobileTextSecondary
import ai.autopus.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.autopus.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.autopus.app.ui.mobileFontFamily,
