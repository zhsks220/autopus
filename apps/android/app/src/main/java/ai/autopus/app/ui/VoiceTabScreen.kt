...
import ai.autopus.app.VoiceCaptureMode
import ai.autopus.app.voice.VoiceConversationEntry
import ai.autopus.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Autopus is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
