...
struct AutopusMacCLI {
    static func main() async {
        ...
        default:
            fputs("autopus-mac: unknown command\n", stderr)
            printUsage()
            exit(1)
        }
    }
...
private func printUsage() {
    ...
    Examples:
      autopus-mac connect
      autopus-mac connect --url ws://127.0.0.1:18789 --json
      autopus-mac discover --timeout 3000 --json
      autopus-mac wizard --mode local
    """)
}
