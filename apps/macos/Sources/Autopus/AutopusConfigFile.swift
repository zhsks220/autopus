...
enum AutopusConfigFile {
    private static let logger = Logger(subsystem: "ai.autopus", category: "config")
    ...
    static func url() -> URL {
        AutopusPaths.configURL
    }

    static func stateDirURL() -> URL {
        AutopusPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        AutopusPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-autopus-config-file",
            "event": "config.write",
