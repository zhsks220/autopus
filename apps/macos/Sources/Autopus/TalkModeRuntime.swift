...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.autopus", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.autopus", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [AutopusChatMessage] = messages.compactMap { item in
