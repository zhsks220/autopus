...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.autopus", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Autopus/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__autopus__/a2ui/").absoluteString + "?platform=macos"
    }
