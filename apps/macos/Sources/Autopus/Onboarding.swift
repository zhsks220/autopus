...
enum UIStrings {
    static let welcomeTitle = "Welcome to Autopus"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "autopus.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: AutopusChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g autopus@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: AutopusChatViewModel(
