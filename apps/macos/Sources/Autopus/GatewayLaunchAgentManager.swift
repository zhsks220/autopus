...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.autopus", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".autopus/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.autopusCommand(
            subcommand: "gateway",
