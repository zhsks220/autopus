...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.autopus", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Autopus windows, but below the system’s pop-up menus.
