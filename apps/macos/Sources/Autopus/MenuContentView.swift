...
/// Menu contents for the Autopus menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Autopus") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "Autopus Not Configured"
        case .remote:
            "Remote Autopus Active"
        case .local:
            "Autopus Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .autopusSelectSettingsTab, object: tab)
        }
    }
