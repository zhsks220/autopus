...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.autopus", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return AutopusConfigFile.defaultWorkspaceURL() }
