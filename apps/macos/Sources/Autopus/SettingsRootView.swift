...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .autopusSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? AutopusPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? AutopusPaths.stateDirURL.path
...
extension Notification.Name {
    static let autopusSelectSettingsTab = Notification.Name("autopusSelectSettingsTab")
}
