...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/autopus/autopus") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/autopus/autopus")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://autopus.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "AutopusBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AutopusBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "AutopusGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "AutopusGitCommit") as? String) ??
            "unknown"
    }
