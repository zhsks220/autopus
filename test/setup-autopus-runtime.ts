...
const WORKER_RUNTIME_STATE = Symbol.for("autopus.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("autopus.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("autopus.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: AutopusConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
